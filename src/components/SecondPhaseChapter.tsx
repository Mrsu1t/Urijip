...
export const SecondPhaseChapter: React.FC<SecondPhaseChapterProps> = ({
  ...
  // Warm Rose & Bubblegum Pink Ambient Glow (Expands after video: 0.55 -> 1.0)
  const warmRoseAlpha =
    scrollProgress < 0.5
      ? 0.05
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-[100svh] w-full flex flex-col justify-between overflow-hidden px-4 sm:px-8 md:px-12 py-5 sm:py-7">
        ...
        {/* Layer B: Warm Rose & Bubblegum Glow */}
        <div
          className="absolute inset-0 pointer-events-none transition-opacity duration-700 ease-out"
          style={{
            opacity: warmRoseAlpha,
            background:
              'radial-gradient(ellipse 90% 80% at 50% 45%, rgba(232, 128, 185, 0.24) 0%, rgba(125, 46, 104, 0.16) 45%, transparent 80%)',
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            background:
              'radial-gradient(circle, rgba(250, 245, 235, 0.20) 0%, rgba(244, 143, 177, 0.14) 50%, transparent 80%)',
          }}
        />
        ...
        >
          ...
          <div className="absolute top-[26%] right-[19%] w-1 h-1 rounded-full bg-pink-100/60 shadow-[0_0_6px_rgba(255,220,240,0.8)]" />
          <div className="absolute bottom-[28%] left-[22%] w-1.5 h-1.5 rounded-full bg-white/60 shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
          <div className="absolute top-[68%] right-[16%] w-1.5 h-1.5 rounded-full bg-pink-200/70 shadow-[0_0_8px_rgba(255,200,230,0.8)] animate-pulse" />
          <div className="absolute top-[42%] left-[9%] w-1 h-1 rounded-full bg-white/45" />
          <div className="absolute bottom-[18%] right-[28%] w-1 h-1 rounded-full bg-pink-100/55" />
        </div>
        ...
        <div className="relative w-full max-w-4xl mx-auto flex-1 flex items-center justify-center z-20 my-auto px-2">
          ...
          >
            <div className="space-y-5 sm:space-y-7 max-w-2xl mx-auto">
              ...
              <p className="font-editorial italic text-[clamp(1.4rem,3.6vw,2.4rem)] font-light text-pink-100 leading-relaxed max-w-xl mx-auto">
                I&apos;ve only shown you what I could put into words.
              </p>

              <p className="font-body text-[clamp(0.95rem,2.1vw,1.25rem)] font-normal text-pink-100/80 max-w-lg mx-auto leading-relaxed pt-1">
          ...
          >
            <div className="space-y-6 sm:space-y-8 max-w-2xl mx-auto">
              <p className="font-editorial text-[clamp(1.75rem,4.5vw,3.2rem)] font-light leading-relaxed text-pink-100">
                Everything you&apos;ve seen so far...
              </p>

              <div className="w-12 h-[1px] bg-gradient-to-r from-transparent via-pink-200/40 to-transparent mx-auto" />
              ...
              <p className="font-body text-[clamp(0.9rem,2vw,1.15rem)] font-normal text-pink-100/70 max-w-md mx-auto leading-relaxed pt-1">
          ...
          >
            <div className="space-y-6 max-w-2xl mx-auto flex flex-col items-center">
              <p className="font-body text-xs sm:text-sm uppercase tracking-[0.3em] text-pink-200/80 font-medium">
                The Portal Awaits
              </p>
              ...
              <button
                ...
                className="group relative inline-flex items-center justify-center px-6 sm:px-10 py-4 sm:py-5 rounded-full border border-pink-200/40 bg-gradient-to-r from-pink-950/40 via-purple-950/30 to-pink-950/40 backdrop-blur-xl shadow-[0_0_30px_rgba(244,143,177,0.25)] hover:shadow-[0_0_45px_rgba(244,143,177,0.45)] hover:border-pink-200/70 transition-all duration-500 cursor-pointer max-w-[90vw]"
                aria-label="Click to enter the second phase of this adventure"
              >
                {/* Luminous Edge */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-pink-300/10 via-white/20 to-pink-300/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />

                <span className="font-editorial text-sm sm:text-lg md:text-xl uppercase tracking-[0.14em] text-white font-medium group-hover:text-pink-100 transition-colors text-center leading-snug">
          ...
          >
            <div className="w-full max-w-3xl flex flex-col items-center">
              ...
              <div className="relative w-full aspect-video rounded-2xl overflow-hidden border border-pink-200/25 bg-gradient-to-b from-[#0e1220] to-[#04060a] shadow-[0_0_40px_rgba(244,143,177,0.2)] flex items-center justify-center group">
                ...
                {FINAL_VIDEO_URL && FINAL_VIDEO_URL.trim().length > 0 ? (
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <button
                              ...
                              className="p-2 rounded-full bg-pink-400/20 hover:bg-pink-400/30 text-white transition-colors"
                  ...
                  /* Dedicated Isolated Video Placeholder (Clean, minimal, cinematic, ready for video insertion) */
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                    {/* Atmospheric Backdrop */}
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(232,128,185,0.12)_0%,_rgba(10,17,40,0.85)_75%)] pointer-events-none" />

                    {/* Centralized Play Motif */}
                    <button
                      onClick={handleTogglePlay}
                      className="group/btn relative w-16 h-16 sm:w-20 sm:h-20 rounded-full border border-pink-200/40 bg-pink-500/10 hover:bg-pink-500/20 backdrop-blur-md flex items-center justify-center shadow-[0_0_25px_rgba(244,143,177,0.35)] transition-all duration-300 cursor-pointer z-10"
                      aria-label="Play dedicated video experience"
                    >
                      <Play className="w-7 h-7 sm:w-8 sm:h-8 text-pink-100 ml-1 group-hover/btn:scale-110 transition-transform" />
                    </button>
                    ...
                    <div className="relative z-10 mt-5 space-y-1 max-w-md">
                      ...
                      <p className="font-body text-[11px] sm:text-xs text-pink-100/60 uppercase tracking-[0.2em]">
              ...
              <div className="mt-4 flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-1.5 rounded-full border border-pink-200/20 bg-white/5 hover:bg-white/10 text-pink-100 text-xs font-body tracking-wider transition-colors cursor-pointer"
                >
                  Continue to Home →
                </button>
              </div>
          ...
          >
            <div className="space-y-6 sm:space-y-8 max-w-2xl mx-auto">
              <h2
                ...
                style={{
                  textShadow:
                    '0 0 45px rgba(255, 240, 250, 0.95), 0 0 90px rgba(244, 143, 177, 0.65), 0 0 130px rgba(232, 128, 185, 0.4)',
                }}
              >
                URIJIP
              </h2>

              <p className="font-editorial text-[clamp(1.5rem,4.2vw,2.85rem)] font-light text-pink-100 leading-relaxed max-w-xl mx-auto">
                Urijip exists because you made{' '}
                <span className="font-semibold text-white tracking-wide underline decoration-pink-300/40 decoration-1 underline-offset-8">
                  this our home
                </span>
                .
              </p>
          ...
          >
            <div className="space-y-4 sm:space-y-6 max-w-2xl mx-auto text-pink-100">
              ...
              <p className="font-editorial text-[clamp(1.3rem,3.2vw,2.1rem)] font-light leading-relaxed text-pink-100/95">
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 max-w-md mx-auto pt-2 font-editorial italic text-[clamp(1.15rem,2.8vw,1.75rem)] text-white/90">
                ...
                <span>A message.</span>
                <span className="text-pink-300/40">•</span>
                <span className="text-pink-200">A little piece of us.</span>
              </div>
            </div>
          </div>
          ...
          >
            <div className="space-y-6 max-w-xl mx-auto flex flex-col items-center">
              ...
              <button
                ...
                className="group relative inline-flex items-center justify-center gap-3 px-8 sm:px-12 py-4 sm:py-5 rounded-full border border-pink-200/40 bg-gradient-to-r from-pink-900/30 via-purple-900/25 to-pink-900/30 backdrop-blur-xl shadow-[0_0_35px_rgba(244,143,177,0.3)] hover:shadow-[0_0_55px_rgba(244,143,177,0.5)] hover:border-pink-200/70 transition-all duration-500 cursor-pointer"
                aria-label="Enter Phase Two Spotify playlist"
              >
                {/* Luminous Edge */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-pink-300/15 via-white/20 to-pink-300/15 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />

                <span className="font-editorial text-lg sm:text-2xl uppercase tracking-[0.18em] text-white font-medium group-hover:text-pink-100 transition-colors">
                  ENTER PHASE TWO →
                </span>
                <ExternalLink className="w-4 h-4 sm:w-5 sm:h-5 text-pink-200 group-hover:translate-x-1 transition-transform" />
              </button>

              {/* Everlasting Starlight Callback */}
              <div className="pt-4 space-y-2">
                <p className="font-editorial italic text-sm sm:text-base text-pink-100/70 tracking-wide">
      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className="fixed bottom-10 left-1/2 -translate-x-1/2 px-6 py-3 rounded-full border border-pink-200/30 bg-black/85 backdrop-blur-xl text-pink-100 text-xs sm:text-sm font-body tracking-wider shadow-2xl z-50 pointer-events-none"
          >
            {toastMessage}
          </motion.div>
        )}
