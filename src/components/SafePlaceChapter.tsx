...
export const SafePlaceChapter: React.FC<SafePlaceChapterProps> = ({
  ...
  // -------------------------------------------------------------
  const nightSkyAlpha = range(scrollProgress, 0.0, 0.5, 0.45, 0.7);
  const auroraAlpha = range(scrollProgress, 0.15, 0.8, 0.2, 0.5);
  const sanctuaryLightAlpha = range(scrollProgress, 0.4, 0.95, 0.15, 0.35);
  ...
  return (
    ...
    >
      {/* ------------------------------------------------------------- */}
      {/* EXPANSIVE NIGHT SKY & AURORA ATMOSPHERE                       */}
      {/* ------------------------------------------------------------- */}

      {/* Layer A: Deep Night Sky Base */}
      <div
        className="fixed inset-0 pointer-events-none transition-opacity duration-1000"
        style={{
          background: 'radial-gradient(ellipse 110% 95% at 50% 50%, rgba(15, 23, 42, 0.7) 0%, rgba(10, 15, 30, 0.5) 52%, transparent 100%)',
          opacity: nightSkyAlpha,
          zIndex: Z_INDEX_TOKENS.ambientGlow + 12,
        }}
      />

      {/* Layer B: Aurora Emerald Radiance */}
      <div
        className="fixed inset-0 pointer-events-none transition-opacity duration-1000"
        style={{
          background: 'radial-gradient(circle at 50% 52%, rgba(16, 185, 129, 0.15) 0%, rgba(14, 165, 233, 0.1) 48%, transparent 100%)',
          opacity: auroraAlpha,
          zIndex: Z_INDEX_TOKENS.ambientGlow + 13,
        }}
      />

      {/* Layer C: Starlight Light Pool */}
      <div
        className="fixed inset-0 pointer-events-none transition-opacity duration-1000"
        style={{
          background: 'radial-gradient(ellipse 85% 75% at 50% 50%, rgba(255, 255, 255, 0.12) 0%, rgba(186, 230, 253, 0.05) 42%, transparent 80%)',
        ...
        <div className="relative w-full max-w-4xl mx-auto flex-1 flex flex-col items-center justify-center my-auto min-h-[390px]">
          ...
          >
            ...
            <h2
              ...
              style={{
                textShadow: '0 0 35px rgba(255, 255, 255, 0.85), 0 0 75px rgba(56, 189, 248, 0.35)',
              }}
            >
              THE SAFE PLACE
            </h2>
            <div className="space-y-1 text-slate-200 max-w-md mx-auto">
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-3.5 text-white/95 max-w-xl mx-auto">
              ...
              <p className="font-editorial text-[clamp(1.2rem,3vw,1.85rem)] font-light leading-relaxed text-slate-200">
                I can have boundaries.
              </p>
              <p className="font-editorial text-[clamp(1.2rem,3vw,1.85rem)] font-light leading-relaxed">
                I can make my own choices.
              </p>
              <p className="font-editorial text-[clamp(1.25rem,3.2vw,1.95rem)] font-light leading-relaxed text-cyan-200">
          ...
          >
            ...
            <h3 className="font-editorial text-[clamp(1.5rem,3.8vw,2.4rem)] text-slate-200 font-light tracking-wide">
              How You Show Up
            </h3>
            ...
            <div className="space-y-2.5 text-white/95 max-w-xl mx-auto">
              ...
              <p className="font-editorial text-[clamp(1.25rem,3.2vw,2rem)] font-light leading-snug text-slate-200">
          ...
          >
            ...
            <div className="p-4 sm:p-5 rounded-2xl border border-white/20 bg-white/[0.06] backdrop-blur-md max-w-xl mx-auto space-y-2">
            ...
            <div className="space-y-1.5 text-white/90">
              ...
              <p className="font-editorial italic text-[clamp(1.35rem,3.5vw,2.25rem)] text-slate-100 font-normal">
                You celebrated it with me.
              </p>
            </div>

            <p className="font-editorial text-[clamp(1.2rem,2.8vw,1.8rem)] text-slate-200 pt-1 font-medium">
          ...
          >
            ...
            <div className="space-y-1.5 text-white/90">
              ...
              <p className="font-editorial text-[clamp(1.2rem,3vw,1.85rem)] text-slate-300 font-light leading-snug">
                You&apos;ve trusted me with a part of you.
              </p>
              <p className="font-editorial italic text-[clamp(1.25rem,3.2vw,1.95rem)] text-cyan-200 font-normal leading-snug">
            ...
            <div className="pt-3">
              <h2
                ...
                style={{
                  textShadow: '0 0 35px rgba(255, 255, 255, 0.9), 0 0 75px rgba(56, 189, 248, 0.4)',
                }}
              >
          ...
          >
            ...
            <div className="space-y-2 text-white/95 max-w-xl mx-auto">
              ...
              <p className="font-editorial text-[clamp(1.4rem,3.6vw,2.35rem)] font-light leading-snug text-slate-200">
                Your pillow.
              </p>
            ...
            <div className="pt-2 px-4 py-2 rounded-2xl border border-white/15 bg-white/[0.04] backdrop-blur-sm max-w-md mx-auto">
              <p className="font-editorial italic text-xs sm:text-sm text-slate-300 leading-relaxed">
          ...
          >
            ...
            <h2
              ...
              style={{
                textShadow: '0 0 45px rgba(255, 255, 255, 0.95), 0 0 85px rgba(56, 189, 248, 0.45)',
              }}
            >
            ...
            <div className="space-y-2 text-white/95 max-w-lg mx-auto pt-1">
              <p className="font-editorial text-[clamp(1.25rem,3vw,1.9rem)] font-light leading-relaxed text-slate-200">
